...
When using AI tools to generate or modify code:

- **You** review the generated code thoroughly
- **You** ensure the code is correct and meets project standards
- **You** test the code to verify it works as intended
- **You** add "AI Assisted" or "Copilot Assisted" comments to the code
- **You** disclose the AI tools used in the PR description
- **You** take responsibility for the quality and functionality of the contribution

This ensures we maintain code quality while benefiting from AI-assisted development.
